...
import { X, DollarSign, Calendar, CreditCard, Banknote, Building, AlertTriangle, Calculator } from 'lucide-react';
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <span className="ml-2 font-medium">LKR {formData.amount.toLocaleString()}</span>
              </div>
              <div>
                <span className="text-green-600">Penalty:</span>
                <span className="ml-2 font-medium">LKR {formData.penalty.toLocaleString()}</span>
              </div>
              <div>
                <span className="text-green-600">Total Collected:</span>
                <span className="ml-2 font-medium">LKR {(formData.amount + formData.penalty).toLocaleString()}</span>
              </div>
              <div>
                <span className="text-green-600">Remaining Balance:</span>
                <span className="ml-2 font-medium">LKR {Math.max(0, repayment.balance - formData.amount).toLocaleString()}</span>
              </div>
            </div>
          </div>
