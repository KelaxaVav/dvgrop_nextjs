...
export default function ContactManager() {
  ...
  const [selectedContact, setSelectedContact] = useState<IEmailContact | null>(null);
  ...
  const handleEditContact = (contact: IEmailContact) => {
                  ...
                  <tr key={contact._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col space-y-1">
                        ...
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${contact.isSubscribed ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                          }`}>
